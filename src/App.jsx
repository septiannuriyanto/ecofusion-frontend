...
import NavbarMenu from "./components/HybridEnergy/NavbarMenu";
...
import summary from "./screens/Pages/Summary";
import configtest from "./screens/Pages/ConfigTest";
import history from "./screens/Pages/History";
import scheduling from "./screens/Pages/Scheduling";
import tasklist from "./screens/Pages/Tasklist";

import equipment from "./screens/Pages/Resources/Equipment";
          ...
          <>
              ...
              <div id="main-content">
                <Switch>
                  ...
                  <Route
                    exact
                    path={`${process.env.PUBLIC_URL}/scheduling`}
                    component={scheduling}
                  />
                  <Route
                    exact
                    path={`${process.env.PUBLIC_URL}/configtest`}
                  ...
                  <Route
                    exact
                    path={`${process.env.PUBLIC_URL}/tasklist`}
                    component={tasklist}
                  />
                  <Route
                    exact
