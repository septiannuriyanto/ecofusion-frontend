...
class NavbarMenu extends React.Component {
  ...
  activeMenutabwhenNavigate(activeKey) {
    if (
      ...
      this.activeMenutabContainer("ResourcesContainer");
    }
    else if (
        ...
        {isToastMessage ? (
          ...
          >
            <Toast.Header className="toast-info mb-0">
              Hello, Septian Nuriyanto,<br/>A good day to think about environment.
            </Toast.Header>
          </Toast>
        ) : null}
            ...
            <div className="user-account">
              ...
              <Dropdown>
                ...
                <Dropdown.Toggle
                  ...
                  className="user-name"
                >
                  <strong>Septian Nuriyanto</strong>
                </Dropdown.Toggle>
                ...
                <Nav id="left-sidebar-nav" className="sidebar-nav">
                  <ul id="main-menu" className="metismenu">
                    <li className="" id="dashboradContainer">
                      ...
                      <li
                          className={activeKey === "summary" ? "active" : ""}
                        >
                    ...
                    <li id="AppContainer" className="">
                      ...
                      >
                        <i className="icon-grid"></i> <span>Activities</span>
                      </a>
                      <ul className="collapse">
                      <li
                          className={
                            activeKey === "scheduling" ? "active" : ""
                          }
                          onClick={() => {}}
                        >
                      ...
                      <li
                          className={activeKey === "maintenance" ? "active" : ""}
                          onClick={() => {}}
                        >
                          <Link to="configtest">Config test</Link>
                        </li>
                        <li
                          className={activeKey === "activitylog" ? "active" : ""}
                          onClick={() => {}}
                        >
                    ...
                    <li id="ResourcesContainer" className="">
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                      ...
                      <ul className="collapse">
                        <li
                          className={
                            activeKey === "resourcesdashboard" ? "active" : ""
                          }
                          onClick={() => {}}
                        >
                    ...
                    <li id="FileManagerContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="BlogContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="UIElementsContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#uiElements"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="WidgetsContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="AuthenticationContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="PagesContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="FormsContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="TablesContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="chartsContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
                    ...
                    <li id="MapsContainer" className="" style={this.state.developmentMode===false? {display: "none"} : {display: "block"}}>
                      <a
                        href="#!"
                        className="has-arrow"
                        onClick={(e) => {
