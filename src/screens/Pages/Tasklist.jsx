        ...
        <div>
          <div className="ng-star-inserted">
            <div className="container-fluid">
              <PageHeader
                HeaderText="TaskList"
                Breadcrumb={[{ name: "Activities" }, { name: "TaskList" }]}
              />
                                ...
                                >
                                  <li className="dd-item">
                                    ...
                                    <div className="dd-content p-15">
                                      <h5>Testing GS747</h5>
                                      <p>
                                        Test akan dilakukan dengan konfigurasi #34 pada jam 18:05
                                      </p>
                                      <ul className="list-unstyled team-info m-t-20 m-b-20">
                                        <li className="m-r-15">
                                ...
                                >
                                  <li className="dd-item">
                                    ...
                                    <div className="dd-content p-15">
                                      <h5>Testing GS547</h5>
                                      <p>
                                        Testing dilakukan sesuai brief, menggunakan konfigurasi #47<br/>Target Efisiensi : 75%
                                      </p>
                                      <ul className="list-unstyled team-info m-t-20 m-b-20">
                                        <li className="m-r-15">
                                          <small className="text-muted">
                                ...
                                >
                                  <li className="dd-item">
                                    ...
                                    <div className="dd-content p-15">
                                      <h5>Testing GS747</h5>
                                      <p>
                                        Testing dilakukan dengan konfigurasi #26,<br/> Target Efisiensi 75%<br/> Aktual Efisiensi : 65%<br/>Action : Retrain Machine Learning
                                      </p>
                                      <ul className="list-unstyled team-info m-t-20 m-b-20">
                                        <li className="m-r-15">
                                          <small className="text-muted">
